 ...
 */
public class MyTeslaLoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
//            //JSONObject data = mTeslaClient.ListAllVehicles();
//            JSONObject data = new JSONObject();
//            TestRequestAsyncTask task = new TestRequestAsyncTask(data, mTeslaClient);
//            task.execute("");
//            if(data != null)
...
//            }
        ...
        setContentView(R.layout.activity_my_tesla_login);
    ...
    */
    ...
    private void addEmailsToAutoComplete(List<String> emailAddressCollection) {
        ...
        ArrayAdapter<String> adapter =
                new ArrayAdapter<>(MyTeslaLoginActivity.this,
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        */
            ...
            successful = mTeslaClient.Login(mEmail,mPassword);
            if(successful)
            {
                mTeslaClient.saveOauthToken(mSharedPreferences);
            }
            return successful;
                /*
